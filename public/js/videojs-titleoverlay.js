...
(function(factory) {
    ...
    var title_defaults = {
        ...
        margin: '0px',
        padding: '10px',
        background: 'linear-gradient(to bottom, rgba(219,219,219,1) 0%, rgba(209,209,209,1) 0%, rgba(0,0,0,1) 0%, rgba(247,247,247,0.24) 76%, rgba(254,254,254,0) 100%)',
        fontSize: '2em'
    }
    ...
    var TitleOverlayPlugin = function(player, options) {
        ...
        var createOverlayContainer_ = function() {
            ...
            this.titleOverlayTextContainer.style.padding = options.padding || title_defaults.padding;
            this.titleOverlayTextContainer.style.fontSize = options.fontSize || title_defaults.fontSize;
            this.titleOverlayTextContainer.style.background = options.background || title_defaults.background;
            this.titleOverlayTextContainer.style.width = options.width || title_defaults.width;
